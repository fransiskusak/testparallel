...
Scenario: Mengedit password sebuah akun pada aplikasi e-LOK
...
When Pengguna memasukkan 'Elokelok25,' pada textbox New password
When Pengguna mengeklik textbox New password (again)
When Pengguna memasukkan 'Elokelok25,' pada textbox New password (again)
